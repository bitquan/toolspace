...
void main() {
  ...
  group('TimestampConverter - Format Conversions', () {
    ...
    test('formats to human readable date only', () {
      final dateTime = DateTime(2024, 1, 15, 10, 30, 45);
      final result = TimestampConverter.toHumanReadable(dateTime, includeTime: false);
    ...
    test('formats with custom TimeFormat enum', () {
      ...
      final timeOnly = TimestampConverter.formatCustom(dateTime, TimeFormat.timeOnly);
  ...
  group('TimestampConverter - Edge Cases', () {
    ...
    test('handles different timezone strings', () {
      ...
      expect(
        () => TimestampConverter.parseNaturalLanguage('now', timezone: 'America/New_York'),
        returnsNormally,
      );
    });
  });
